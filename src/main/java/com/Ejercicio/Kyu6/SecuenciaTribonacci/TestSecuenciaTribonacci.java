...
public class TestSecuenciaTribonacci {
    public static void main(String[] args) {
        System.out.println("Test Secuencia Tribonacci");
    }

    private CalcularSecuenciaTribonacci variabonacci;

    @Before
    public void setUp() throws Exception {
        variabonacci = new CalcularSecuenciaTribonacci();
    }
