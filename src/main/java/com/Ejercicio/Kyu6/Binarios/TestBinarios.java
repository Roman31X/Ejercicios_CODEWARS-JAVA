...
import static com.Ejercicio.Kyu6.Binarios.ConvertirBinarioDecimal.code;
import static com.Ejercicio.Kyu6.Binarios.ConvertirBinarioDecimal.decode;
import static org.junit.Assert.assertEquals;

public class TestBinarios {
    public static void main(String[] args) {
        System.out.println("Test convertir Binarios a Decimales");
    }
    private static void testingCode(String s, String expected) {
        String actual = code(s);
