...
public class TestMenorNumeroArraysIndiceNumero {
    public static void main(String[] args) {
        ...
        System.out.println("Test de array [1,2,3] INDICE : "+PequellodelArreglo(new int[]{1,2,3},"index") );
        System.out.println("Test de array [7, 12, 3, 2, 27] VALOR : "+PequellodelArreglo(new int[]{7, 12, 3, 2, 27},"value") );
